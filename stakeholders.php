...
<?php require_once 'include.header.php'; ?>
  ...
  <p> 
    In October 2016 the Metabolism of Cities website launched the <strong>Stakeholders Initiative</strong>.
  ...
  <ul>
    <li>Online forum discussions</li>
    <li>Blog posts</li>
    <li>Articles about the topic of choice</li>
    <li>Webinars / Skype discussions</li>
  ...
  <p>Below you can find some ideas that we are considering for future Stakeholder Initiative projects. If you 
